...
/**
 * CouchApp design document constructor.
 *
 * @param {string} directory Path to the application root directory.
 * @param {function} callback (err, document) where document is an object
 *   containing a populated _attachments field.
 */

module.exports = function CouchApp (directory, callback) {
  var doc = {
    _attachments: {}
  };
...
var lookup = function (ext, defaultType) {
